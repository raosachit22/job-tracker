    ...
    <div className="min-h-screen login-bg flex items-center justify-center p-4">
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-[#141414] border border-white/10 p-8" style={{ borderRadius: '2px' }}>
          ...
          <p className="text-gray-400 mb-6">Start tracking your job applications today</p>

          {error && (
            <div className="bg-red-500/10 border border-red-500 text-red-400 px-4 py-3 mb-6 text-sm" style={{ borderRadius: '2px' }} data-testid="register-error">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="name" className="text-xs uppercase tracking-[0.2em] text-gray-400 font-bold">Full Name</Label>
          ...
          <p className="mt-6 text-center text-gray-400 text-sm">
            ...
            <Link to="/login" className="text-[#E5FE40] hover:underline font-medium" data-testid="login-link">
              Sign in
            </Link>
          </p>
        </div>
